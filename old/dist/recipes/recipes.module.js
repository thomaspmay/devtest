...
const ingredient_parser_service_1 = require("./ingredient-parser.service");
let RecipesModule = class RecipesModule {
};
RecipesModule = __decorate([
    common_1.Module({
        providers: [recipes_service_1.RecipesService, ingredient_parser_service_1.IngredientParserService],
